...
def save_xlsx():
    ...
    new_font = Font(size=23, underline='single', color='FFBB00', bold=True, italic=True) # change text style
    worksheet['A4'].font = new_font
    new_cell_color = PatternFill(start_color='FFEE1111', end_color='FFEE1111', fill_type='solid') # change cell color
    worksheet['A4'].fill = new_cell_color
